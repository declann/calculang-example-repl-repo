...
const costs = ({
  price_in
}) => 98 * Object(_revenue_with_demand_curve_cul_js__WEBPACK_IMPORTED_MODULE_0__["units"])({
  price_in
});
const profit = ({
  price_in
...
const price = ({
  price_in
}) => price_in; // ?? what if an explicit import in base referred back to A or B?

/***/ })
/******/ ]);
});
//# sourceMappingURL=revenue-with-demand-curve.js.map